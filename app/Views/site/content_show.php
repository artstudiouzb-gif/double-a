        ...
        <aside class="catdetail__aside">
            <div class="catdetail__card">
                ...
                <?php foreach ($sideFields as $f): ?>
                    ...
                    <?php endif; ?>
                <?php endforeach; ?>
                <button type="button" class="catdetail__download" data-print-page>
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" width="16" height="16" aria-hidden="true"><path d="M6 9V2h12v7M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2m-12 0v4h8v-4m-8 0h8"/></svg>
                    <?= htmlspecialchars(t('Распечатать'), ENT_QUOTES) ?>
                </button>
